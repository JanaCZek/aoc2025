...
def test_ga_joltage_real_input():
    input = "[##...##] (0,3,4,6) (1,2,4,5,6) (0,1,2,5,6) (0,1,3,5) (0,2,3,4,6) {29,26,26,12,9,26,26}"

    desired_state, button_sets = parse_line_to_machine_with_joltage(input)
    current_state = [0] * len(desired_state)
    ...
    input = "[######..] (0,1,2,3,4,5) (0,4,5,7) (1,5,7) (3,4,6) (2,6,7) (0,5,7) (2,3,4,7) (5,6,7) (1,3,4,5,6) (1,3,4) {31,51,38,61,77,74,49,72}"
...
def calculate_fitness_score(individual, current_state, desired_state, fitness_cache):
    ...
    score = fitness_cache.get(frozenset(individual.items()), None)
    ...
    fitness_cache[frozenset(individual.items())] = score
